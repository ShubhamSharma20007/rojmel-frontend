      ...
      >
        ...
        >
          <View style={styles.secondaryContainer}>
            ...
            >
              <Text style={[styles.dateText]}>
                {formData.transaction_date
                  ? (formData.transaction_date as Date).toLocaleDateString()
                  : "તારીખ પસંદ કરો"}
              </Text>
            </TouchableOpacity>
            {showDatePicker && (
            ...
            <Text style={styles.label}>આવક/જાવક *</Text>
            ...
            <Text style={styles.label}>આવક/ચુકવણી પદ્ધતિ *</Text>
            <View style={styles.radioGroup}>
